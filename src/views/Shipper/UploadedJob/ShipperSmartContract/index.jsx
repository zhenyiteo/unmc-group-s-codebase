      ...
      <div style={{ display: 'flex' }}>
        <div className={styles.left}>
          <div style={{ position: 'relative' }}>
            ...
            <div>
              Lorem ipsum dolor sit amet consectetur adipising edit,Eget quam
              lucus feugiat sit. Una,semper sagittls non faucibus nunc tortor,id
              sed donec
            </div>
            ...
            <div style={{ marginTop: 20 }}>
              Lorem ipsum dolor sit ametconsectertur adipising ediy,Eget quam
              luctus feugiats feuaislas site, Urna msemper sagittis no faucibus
              nunc tortot,id send donc
            </div>
