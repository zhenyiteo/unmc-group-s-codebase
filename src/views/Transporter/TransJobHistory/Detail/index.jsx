          ...
          <div style={{ flex: 1, marginLeft: 20 }}>
            <div
              style={{
                ...
                item.JobStatus === 'Completed' ? '#00FF00' :
      ...
      <div>
        ...
        <div
          style={{
            ...
            color: '#fff',
            display:  item.JobStatus === "Unlisted" ? "none" : 'flex',
            justifyContent: 'center',
            alignItems: 'center',
            cursor: 'pointer',
            marginTop: '20px'
          ...
          onClick={() => {
            if (!(item.JobStatus === 'Unlisted')){
              ...
              else if (item.JobStatus === 'Available'){
                navigate('/transporter/transContract?JobID=' + item.JobID);
              }
              else{
                navigate('/transporter/transContractHistory?JobID=' + item.JobID);
              }
            }
