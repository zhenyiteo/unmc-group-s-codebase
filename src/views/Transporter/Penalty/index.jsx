...
export default function Add() {
 ...
 useEffect(() => {
  ...
  //       <div style={{ fontSize: 40 }}>Please pay penalty before you proceed</div>
  //     </div>
  //     <div style={{ display: 'flex' }}>
  //       <div>
  //         <img
  ...
  //         <div styles = {{color:"red", fontSize:"50px" }} className={styles.label}>Shipment Penalty</div>
  //             <div styles = {{color:"red", fontSize:"50px" }} className={styles.value}>
  //               {item.penalty}
  //             </div>
  ...
  //           onClick={() => {
  //             setIsLoading(true);
  //             PayPenalty(item, true).then(()=>{navigate('/transporter/availableJob'); setIsLoading(false)});
