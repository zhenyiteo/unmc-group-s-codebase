import { Button, Col, Form, Input, message, Rate, Row, Select, Upload } from 'antd';
  ...
  return (
    <div className={styles.home}>
      <div style={{ display: "flex" }}>
        <span style={{ fontSize: 20, fontWeight: "bold", marginRight: 100 }}>Job History</span>
        <Input.Search placeholder='Search company' style={{ flex: 1 }}></Input.Search>

      </div>
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex" }}>
          <Upload>
            <div style={{ backgroundColor: "#f7f5fe", width: 300, height: 280, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <FileImageOutlined style={{ fontSize: 40, color: "#999" }} />
            </div>
          </Upload>
          <div style={{ flex: 1, marginLeft: 20 }}>
            <div style={{ backgroundColor: "#a9fbb0", height: 40, display: "flex", justifyContent: "space-between", alignItems: "center", padding: 10 }}>
              <span>Status</span>
            ...
            <div>
              <span style={{ color: "#999", marginRight: 10 }}>Rated by Others</span>
              <Rate value={3}></Rate>
            </div>
            <div>
              <a href='/#/transporter/availableJobDetail' >View Attachment</a>
            </div>
            <div style={{ display: "flex", marginTop: 10 }}>
              ...
              <Upload><div className={styles["img-wrapper"]}>
                <FileImageOutlined style={{ fontSize: 40, color: "#999" }} /></div></Upload>
              <Upload><div className={styles["img-wrapper"]}>
                <FileImageOutlined style={{ fontSize: 40, color: "#999" }} /></div></Upload>
              <Upload><div className={styles["img-wrapper"]}>
                <FileImageOutlined style={{ fontSize: 40, color: "#999" }} /></div></Upload>
              ...
              <div style={{ width: 200, height: 120, backgroundColor: "#afb1b6", color: "#fff", display: "flex", justifyContent: "center", alignItems: "center", cursor: "pointer" }} onClick={() => {
                navagite("/transporter/smartContract")
              }}>
                View Smart Contract
              </div>
            </div >
      ...
      <div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <div className={styles["item"]}>
            ...
            <span>Deliver a box of glasses
              to University of</span>
          </div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div className={styles["item"]}>
          ...
          <div className={styles["item"]}>
            <span>Nottingham Malaysia by
              air. Company who are
              able to make sure the</span>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <div className={styles["item"]}>
            <span>glasses are not
              damaged and deliver
              the parcel within 72</span>
