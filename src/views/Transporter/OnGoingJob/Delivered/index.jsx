...
function DeliveredJobDetails() {
  const navigate = useNavigate();
  const { JobID } = useParams();
  const [searchParams, setSearchParams] = useSearchParams();
  const [deliveredJobDetails, setDeliveredJobDetails] = useState([]);
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        setDeliveredJobDetails(response.data.body);
...
export default DeliveredJobDetails;
