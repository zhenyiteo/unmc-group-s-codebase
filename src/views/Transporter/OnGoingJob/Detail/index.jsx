  ...
  .post(
    'https://kcc9v1oqjh.execute-api.us-east-1.amazonaws.com/v2/lambdainvoke',
    {
      ...
      "data": {
        ...
        requestString: JSON.stringify({$class:"org.accordproject.testcontract2.DeliveredRequest"})}
    },{headers:{
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ flex: 1, paddingLeft: 60, marginLeft:"10%"}}>
          ...
          <div style={{ display: "flex", flexDirection: "row"}}>
            <h3 style ={{color:"  #000080"}}><em>{item.JobStatus === "Delivered" ? "Item is delivered. Please wait for Shipper to confirm to complete the last step of the contract" :
            "Once you have delivered, please press Delivered to update the contract state"
            }</em></h3>
